...
<body> 
    <header>
        ...
        <h1 style="color: aliceblue;" id="admin-text">Profesor</h1>
    ...
    <nav>
        <div class="admin-menu">
            <a href="profesor.php" class="menu-item" style="text-align: center;">VOLVER A PERFIL</a>
        </div>
    </nav>
    <br>
    ...
    <table class="tabla">
        ...
        <?php
        // Consultar todos los equipos, uniendo con aulas y alumnos para obtener nombres

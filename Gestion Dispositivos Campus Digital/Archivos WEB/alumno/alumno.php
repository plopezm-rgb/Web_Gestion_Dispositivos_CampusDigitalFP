...
// Obtener detalles del alumno logueado
$stmt = $conexion->prepare("SELECT * FROM alumnos WHERE nombre_usuario = ?");
...
<body> 
    <header>
        ...
        <h1 style="color: aliceblue;" id="admin-text"><?php echo htmlspecialchars($alumnos['nombre'] ?? $_SESSION['usuario']); ?></h1>
    ...
    <nav>
        <div class="admin-menu">
            <a href="mis_equipos.php" class="menu-item">Mis equipos</a>
            <a href="anadir_informe.php" class="menu-item">Informar</a>
        </div>
    </nav>
        <div class="user-info">
            <h3>Información del alumno</h3>
            <p><strong>Nombre:</strong> <?php echo htmlspecialchars($alumnos['Nombre'] ?? 'No disponible'); ?></p>
            <p><strong>Aula:</strong> <?php echo htmlspecialchars($alumnos['ID_Aula'] ?? 'No disponible'); ?></p>
            <p><strong>Usuario:</strong> <?php echo htmlspecialchars($alumnos['nombre_usuario'] ?? 'No disponible'); ?></p>
            <p>

...
<body> 
    ...
    <table class="tabla">
        ...
        $sql = "SELECT al.ID_Alumno, al.Nombre, al.Apellido, a.Nombre AS Aula_Nombre, al.nombre_usuario
                FROM alumnos al
        ...
        <tr>
            ...
            <td><a href="eliminar_alumno_beta.php?ID_Alumno=<?php echo $alumno['ID_Alumno']; ?>">Eliminar</a></td>
        </tr>

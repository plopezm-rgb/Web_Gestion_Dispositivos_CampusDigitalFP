...
<body> 
    ...
    <nav>
        <div class="admin-menu">
            ...
            <a href="anadir_profesor.php" class="menu-item" style="text-align: center;">Añadir Profesor</a>
        </div>
        <form action="eliminar_profesor.php" method="POST">
            ...
            // Obtener la lista de profesores para el select de eliminación
            $sql = "SELECT id, nombre, apellido FROM profesores ORDER BY nombre ASC";
    ...
    <table class="tabla">
        ...
        <?php
        // Consultar todos los profesores para mostrar en la tabla

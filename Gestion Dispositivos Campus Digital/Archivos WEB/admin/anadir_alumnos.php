    ...
    <body> 
        ...
        <nav>
            <div class="admin-menu">
                ...
                <a href="ver_alumnos.php" class="menu-item" style="text-align: center;">Ver alumnos</a>
            </div>
        </nav>
...
if (isset($_POST['registrar'])){
    ...
    $meterdatos = "INSERT INTO alumnos (Nombre, Apellido,ID_Aula, nombre_usuario, contraseña) VALUES ('$nombre', '$apellido','$ID_Aula' ,'$usuario', '$contrasena')";
